...
const EMPTY_DB = {
  ...
  plumbers: [], // { id, userId, especialidad[], descripcion, hourlyRate, address, radioTrabajoKm, latitud, longitud, fotoUrl, portfolio[], disponible, createdAt }
  jobs: [], // { id, clientId, plumberId, title, description, status, agreedPrice, createdAt, completedAt }
  reviews: [], // { id, jobId, plumberId, clientId, rating, comment, createdAt }
